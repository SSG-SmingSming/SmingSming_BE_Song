...
import com.smingsming.song.domain.artist.repository.IArtistRepository;
...
public class ArtistServicIempl implements IArtistService{
    ...
    @Override
    public Artist addArtist(RequestAddArtistDto artistDto, MultipartFile artistThumbnail) {
