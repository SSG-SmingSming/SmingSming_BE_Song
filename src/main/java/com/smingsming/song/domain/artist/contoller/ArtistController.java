...
public class ArtistController {
    ...
    public ResponseEntity<?> addArtist(@RequestParam("artistThumbnail") MultipartFile artistThumbnail,
                                       @RequestPart RequestAddArtistDto artistDto) {
